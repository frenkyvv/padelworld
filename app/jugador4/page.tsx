...
export default function Jugador4() {
  ...
  return (
    <div className="topcontainer">
      <div className="titulo">Jugador 4</div>
      <div className="subtitulo">
        {currentInput === 1 && <div className="inputs"><InputJuego1 jugador="jugador4" onComplete={handleCompleteJuego1} /></div>}
        {currentInput === 2 && <div className="inputs"><InputJuego2 jugador="jugador4" onComplete={handleCompleteJuego2} /></div>}
        {currentInput === 3 && <div className="inputs"><InputJuego3 jugador="jugador4" onComplete={handleCompleteJuego3} /></div>}
        {currentInput === 4 && <div className="inputs"><InputJuego4 jugador="jugador4" onComplete={handleCompleteJuego4} /></div>}
        {currentInput === 5 && <div className="inputs"><InputJuego5 jugador="jugador4" onComplete={handleCompleteJuego5} /></div>}
        {currentInput === 6 && <div className="inputs"><InputJuego6 jugador="jugador4" onComplete={handleCompleteJuego6} /></div>}
        {currentInput === 7 && <div className="inputs"><InputJuego7 jugador="jugador4" onComplete={handleCompleteJuego7} /></div>}
        {currentInput === 8 && <div className="inputs"><InputJuego8 jugador="jugador4" onComplete={handleCompleteJuego8} /></div>}
      </div>
