      ...
      await runTransaction(db, async (transaction) => {
        for (const jugador in resultados) {
          if (resultados[jugador] !== '') {
            ...
            transaction.update(jugadorRef, { j1: Number(resultados[jugador]) });
          }
        }
      });
  ...
  return (
    <div>
      ...
      <table className="table table-bordered">
        ...
        <tbody>
          <tr>
            <td className="text-center">{jugadores.jugador5 || 'Emilio'}</td>
            <td className="text-center">
              <input
                type="number"
            ...
            <td className="text-center">{jugadores.jugador7 || 'Memo'}</td>
          </tr>
          <tr>
